...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String totalAndroidStringSubtotalViewModelSubtotal = null;
        ...
        if ((dirtyFlags & 0xdfL) != 0) {
            ...
            if ((dirtyFlags & 0xc2L) != 0) {
                    ...
                    totalAndroidStringSubtotalViewModelSubtotal = total.getResources().getString(R.string.subtotal, viewModelSubtotalGetValue);
                    // read @android:string/subtotal
        ...
        if ((dirtyFlags & 0xc1L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.accompanimentPrice, viewModelAccompanimentName);
        ...
        if ((dirtyFlags & 0xc2L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.total, totalAndroidStringSubtotalViewModelSubtotal);
        }
        if ((dirtyFlags & 0xd0L) != 0) {
            // api target 1
